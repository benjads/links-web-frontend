...
const PageOurStory = () => {
    const desc = 'Our club members were tired of the way traditional service clubs operated, so we did something about it. We are a network of individuals around the globe who meet virtually and strive to make a positive impact on our communities.';
